...
// 任务来源
export type TaskSourceType = 'manual' | 'development_event' | 'external_sync';

// 项目文档类型
export type ProjectDocumentType = 'goal' | 'implementation' | 'spec' | 'note';

// 项目版本状态
export type ProjectVersionStatus = 'planning' | 'active' | 'released';

// 文档阶段状态
export type ProjectDocumentStageStatus = 'todo' | 'in_progress' | 'done';
...
// 版本文档
export interface ProjectVersionDocument extends ProjectDocumentRef {
  versionId: string;
  stages: ProjectDocumentStage[];
}

// 新增任务前的文档更新记录
export interface ProjectTaskPreparationRecord {
  id: string;
  versionId: string;
...
export interface ProjectVersion {
  ...
  goal?: ProjectGoal;
  documents: ProjectVersionDocument[];
  taskCreationRules?: string[];
  taskPreparationHistory?: ProjectTaskPreparationRecord[];
  updatedAt: string;
}

// 项目跟踪接口
export interface ProjectTrackingPortal {
...
export interface Project {
  ...
  tracking?: ProjectTrackingPortal;
  isArchived: boolean;
  createdAt: string;
  updatedAt: string;
}
