                ...
                <div className="flex flex-col gap-2">
                  {isDesktop ? (
                    <>
                      <button
                        type="button"
                        className="px-3 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"
                        onClick={() => {
